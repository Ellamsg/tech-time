    ...
    <div className=" ">
      <div className="courses rounded-[16px]  bg-[#FFFFFF] p-1 lg:p-3">
        ...
        <div className="div flex justify-between py-1">
            <div className="courses-card font-bold text-[#1E5DCE] text-[8px] px-3 md:text-[11px] lg:text-[12px] lg:px-5 p-1
             lg:rounded-[18px] rounded-[14px]">
               <p>{props.topic}</p>
            </div>
           <div className=" flex gap-1 grey font-semibold">
            <p className="text-[6px] lg:text-[12px] lg:pt-1 pt-1">23</p>
        ...
        <h1 className="text-left text-8px lg:text-[24px] my-2 font-semibold  ">{props.title}</h1>
        <div className="div flex justify-between">
            <div  className="clock flex gap-1">
               <img className="w-[10px] lg:w-[20px] object-contain" src="images/times.png"/>
               <p className="grey">24 hrs</p>
            </div>
