    ...
    <div className="footer grid pt-[90px] pb-[240px] md:grid-cols-2 lg:grid-cols-4 grid-cols-1  justify-between p-3 lg:p-6 bg-[#000F24] text-white text-left">
       <div className="foot1 pb-2  ">
        ...
        <div className="foot3  ">
            ...
            <div className="flex   ">
         <input placeholder="enter text" className="h-[46px] lg:w-[180px]  w-[263px] border-2 border-[#054FB3] bg-[#2A2A2B]"  type="text" />
          
         <button className="bg-oceanblue px-2 text-[14px] h-[46px] text-white">Send Message</button>
            </div>
        </div>
    </div>
    )
